...
namespace MediTechSolution_mainProject.API.Migrations
{
    ...
    [Migration("20240113051727_slots-updatess")]
    partial class slotsupdatess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.AddHelpDeskModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.News", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.ReplyToPatientsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReplyToPatientsModels");
                });

            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.SendingRequestToDoctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SendingRequestToDoctors");
                });
            ...
            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.Slots", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MediTechSolution_mainProject.API.Model.ReplyToPatientsModel", b =>
                {
                    b.HasOne("MediTechSolution_mainProject.API.Model.User", "User")
                        .WithMany()
